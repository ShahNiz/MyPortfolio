        ...
        <section className="contact section" id="contact">
            ...
            <div className="contact__container container grid">
                <div className="contact__content">
                    ...
                    <div className="contact__info">
                        <div className="contact__card">
                            ...
                            <span className="contact__card-data">ahmed0072345@gmail.com</span>
                ...
                <div className="contact__content">
                    ...
                    {/* Replace YOUR_FORMSPREE_ENDPOINT with your real form endpoint */}
                    <form action="https://formspree.io/f/xzzvrrnz" method="POST" className="contact__form">
